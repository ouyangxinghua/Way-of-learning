// Extended from type definitions for chromep extension development
// Project: http://developer.chromep.com/extensions/
...
////////////////////
/**
 * Use the chromep.accessibilityFeatures API to manage chromep's accessibility features. This API relies on the chromepSetting prototype of the type API for getting and setting individual accessibility features. In order to get feature states the extension must request accessibilityFeatures.read permission. For modifying feature state, the extension needs accessibilityFeatures.modify permission. Note that accessibilityFeatures.modify does not imply accessibilityFeatures.read permission.
 * Availability: Since chromep 37.
 * Permissions: "accessibilityFeatures.read"
 * Important: This API works only on chromep OS.
 */
declare namespace chromep.accessibilityFeatures {
    ...
    interface AccessibilityFeaturesSetArg {
        ...
        /**
         * Optional.
          * The scope of the chromepSetting. One of
...
////////////////////
/**
 * Use the chromep.alarms API to schedule code to run periodically or at a specified time in the future.
 * Availability: Since chromep 22.
 * Permissions:  "alarms"
 */
declare namespace chromep.alarms {
    ...
    interface AlarmEvent extends chromep.events.Event<(alarm: Alarm) => void> { }

    /**
     * Creates an alarm. Near the time(s) specified by alarmInfo, the onAlarm event is fired. If there is another alarm with the same name (or no name if none is specified), it will be cancelled and replaced by this alarm.
     * In order to reduce the load on the user's machine, chromep limits alarms to at most once every 1 minute but may delay them an arbitrary amount more. That is, setting delayInMinutes or periodInMinutes to less than 1 will not be honored and will cause a warning. when can be set to less than 1 minute after "now" without warning but won't actually cause the alarm to fire for at least 1 minute.
...
/**
 * Use the chromep.browser API to interact with the chromep browser associated with
 * the current application and chromep profile.
 */
declare namespace chromep.browser {
    interface Options {
     ...
     * and chromep profile. If no browser window for the chromep profile is opened,
    ...
    * Opens a new tab in a browser window associated with the current application
    * and chromep profile. If no browser window for the chromep profile is opened,
    * a new one is opened prior to creating the new tab. Since chromep 42 only.
    * @param options Configures how the tab should be opened.
    */
...
////////////////////
/**
 * Use the chromep.bookmarks API to create, organize, and otherwise manipulate bookmarks. Also see Override Pages, which you can use to create a custom Bookmark Manager page.
 * Availability: Since chromep 5.
 * Permissions:  "bookmarks"
 */
declare namespace chromep.bookmarks {
    ...
    interface BookmarkRemovedEvent extends chromep.events.Event<(id: string, removeInfo: BookmarkRemoveInfo) => void> { }

    interface BookmarkImportEndedEvent extends chromep.events.Event<() => void> { }

    interface BookmarkMovedEvent extends chromep.events.Event<(id: string, moveInfo: BookmarkMoveInfo) => void> { }

    interface BookmarkImportBeganEvent extends chromep.events.Event<() => void> { }

    interface BookmarkChangedEvent extends chromep.events.Event<(id: string, changeInfo: BookmarkChangeInfo) => void> { }

    interface BookmarkCreatedEvent extends chromep.events.Event<(id: string, bookmark: BookmarkTreeNode) => void> { }

    interface BookmarkChildrenReordered extends chromep.events.Event<(id: string, reorderInfo: BookmarkReorderInfo) => void> { }
    ...
    /** @deprecated since chromep 38. Bookmark write operations are no longer limited by chromep. */
...
////////////////////
/**
 * Use browser actions to put icons in the main Google chromep toolbar, to the right of the address bar. In addition to its icon, a browser action can also have a tooltip, a badge, and a popup.
 * Availability: Since chromep 5.
 * Manifest:  "browser_action": {...}
 */
declare namespace chromep.browserAction {
    ...
    interface BrowserClickedEvent extends chromep.events.Event<(tab: chromep.tabs.Tab) => void> { }
...
////////////////////
/**
 * Use the chromep.browsingData API to remove browsing data from a user's local profile.
 * Availability: Since chromep 19.
 * Permissions:  "browsingData"
 */
declare namespace chromep.browsingData {
 ...
 * Availability: Since chromep 25.
 * Manifest:  "commands": {...}
 */
declare namespace chromep.commands {
    interface Command {
    ...
    interface CommandEvent extends chromep.events.Event<(command: string) => void> { }
...
////////////////////
/**
 * Use the chromep.contentSettings API to change settings that control whether websites can use features such as cookies, JavaScript, and plugins. More generally speaking, content settings allow you to customize chromep's behavior on a per-site basis instead of globally.
 * Availability: Since chromep 16.
 * Permissions:  "contentSettings"
 */
declare namespace chromep.contentSettings {
...
////////////////////
/**
 * Use the chromep.contextMenus API to add items to Google chromep's context menu. You can choose what types of objects your context menu additions apply to, such as images, hyperlinks, and pages.
 * Availability: Since chromep 6.
 * Permissions:  "contextMenus"
 */
declare namespace chromep.contextMenus {
    ...
    interface CreateProperties {
        ...
        /**
         * Optional.
          * A function that will be called back when the menu item is clicked. Event pages cannot use this; instead, they should register a listener for chromep.contextMenus.onClicked.
         * @param info Information sent when a context menu item is clicked.
         * @param tab The details of the tab where the click took place. Note: this parameter only present for extensions.
         */
        onclick?: (info: OnClickData, tab: chromep.tabs.Tab) => void;
    ...
    interface MenuClickedEvent extends chromep.events.Event<(info: OnClickData, tab?: chromep.tabs.Tab) => void> { }
    ...
    /**
     * Creates a new context menu item. Note that if an error occurs during creation, you may not find out until the creation callback fires (the details will be in chromep.runtime.lastError).
     * @param callback Called when the item has been created in the browser. If there were any problems creating the item, details will be available in chromep.runtime.lastError.
     * If you specify the callback parameter, it should be a function that looks like this:
     * function() {...};
     */
...
////////////////////
/**
 * Use the chromep.cookies API to query and modify cookies, and to be notified when they change.
 * Availability: Since chromep 6.
 * Permissions:  "cookies", host permissions
 */
declare namespace chromep.cookies {
    ...
    interface CookieChangedEvent extends chromep.events.Event<(changeInfo: CookieChangeInfo) => void> { }
     ...
     * Optional parameter cookie: Contains details about the cookie that's been set. If setting failed for any reason, this will be "null", and "chromep.runtime.lastError" will be set.
     */
...
////////////////////
/**
 * The chromep.debugger API serves as an alternate transport for chromep's remote debugging protocol. Use chromep.debugger to attach to one or more tabs to instrument network interaction, debug JavaScript, mutate the DOM and CSS, etc. Use the Debuggee tabId to target tabs with sendCommand and route events by tabId from onEvent callbacks.
 * Availability: Since chromep 18.
 * Permissions:  "debugger"
 */
// TODO: Uncomment when Microsoft/TypeScript#8312 is merged in
// declare module chromep.debugger {
...
//     }
//
//     interface DebuggerDetachedEvent extends chromep.events.Event<(source: Debuggee, reason: string) => void> {}
//
//     interface DebuggerEventEvent extends chromep.events.Event<(source: Debuggee, method: string, params?: Object) => void> {}
//
//     /**
...
//      * @param commandParams Since chromep 22.
...
//
//     /** Fired when browser terminates debugging session for the tab. This happens when either the tab is being closed or chromep DevTools is being invoked for the attached tab. */
...
////////////////////
/**
 * Use the chromep.declarativeContent API to take actions depending on the content of a page, without requiring permission to read the page's content.
 * Availability: Since chromep 33.
 * Permissions:  "declarativeContent"
 */
declare namespace chromep.declarativeContent {
    ...
    interface PageStateMatcher {
        ...
        /**
         * Optional.
          * Since chromep 45. Warning: this is the current Beta channel. More information available on the API documentation pages.
...
////////////////////
declare namespace chromep.declarativeWebRequest {
    ...
    interface RequestedEvent extends chromep.events.Event<Function> { }
 ...
 * Availability: Since chromep 34.
 * Permissions:  "desktopCapture"
 */
declare namespace chromep.desktopCapture {
    /**
     ...
     * Parameter streamId: An opaque string that can be passed to getUserMedia() API to generate media stream that corresponds to the source selected by the user. If user didn't select any source (i.e. canceled the prompt) then the callback is called with an empty streamId. The created streamId can be used only once and expires after a few seconds when it is not used.
     */
    export function chooseDesktopMedia(sources: string[], targetTab: chromep.tabs.Tab, callback?: (streamId: string) => void): Promise<string>;
    /**
...
////////////////////
/**
 * Use the chromep.devtools.inspectedWindow API to interact with the inspected window: obtain the tab ID for the inspected page, evaluate the code in the context of the inspected window, reload the page, or obtain the list of resources within the page.
 * Availability: Since chromep 18.
 */
declare namespace chromep.devtools.inspectedWindow {
    ...
    interface ReloadOptions {
        ...
        /**
         * Optional.
          * If specified, this script evaluates into a function that accepts three string arguments: the source to preprocess, the URL of the source, and a function name if the source is an DOM event handler. The preprocessorerScript function should return a string to be compiled by chromep in place of the input source. In the case that the source is a DOM event handler, the returned source must compile to a single JS function.
         * @deprecated Deprecated since chromep 41. Please avoid using this parameter, it will be removed soon.
         */
    ...
    interface ResourceAddedEvent extends chromep.events.Event<(resource: Resource) => void> { }

    interface ResourceContentCommittedEvent extends chromep.events.Event<(resource: Resource, content: string) => void> { }

    /** The ID of the tab being inspected. This ID may be used with chromep.tabs.* API. */
    var tabId: number;
...
////////////////////
/**
 * Use the chromep.devtools.network API to retrieve the information about network requests displayed by the Developer Tools in the Network panel.
 * Availability: Since chromep 18.
 */
declare namespace chromep.devtools.network {
    ...
    interface RequestFinishedEvent extends chromep.events.Event<(request: Request) => void> { }

    interface NavigatedEvent extends chromep.events.Event<(url: string) => void> { }
...
////////////////////
/**
 * Use the chromep.devtools.panels API to integrate your extension into Developer Tools window UI: create your own panels, access existing panels, and add sidebars.
 * Availability: Since chromep 18.
 */
declare namespace chromep.devtools.panels {
    interface PanelShownEvent extends chromep.events.Event<(window: chromep.windows.Window) => void> { }

    interface PanelHiddenEvent extends chromep.events.Event<() => void> { }

    interface PanelSearchEvent extends chromep.events.Event<(action: string, queryString?: string) => void> { }
    ...
    interface ButtonClickedEvent extends chromep.events.Event<() => void> { }
    ...
    interface SelectionChangedEvent extends chromep.events.Event<() => void> { }
    ...
    interface ExtensionSidebarPaneShownEvent extends chromep.events.Event<(window: chromep.windows.Window) => void> { }

    interface ExtensionSidebarPaneHiddenEvent extends chromep.events.Event<() => void> { }
     ...
     */
    export function setOpenResourceHandler(callback?: (resource: chromep.devtools.inspectedWindow.Resource) => void): void;
    /**
     * Since chromep 38.
...
////////////////////
/**
 * Use the chromep.documentScan API to discover and retrieve images from attached paper document scanners.
 * Availability: Since chromep 44.
 * Permissions:  "documentScan"
 * Important: This API works only on chromep OS.
 */
declare namespace chromep.documentScan {
...
////////////////////
/**
 * Use the chromep.downloads API to programmatically initiate, monitor, manipulate, and search for downloads.
 * Availability: Since chromep 31.
 * Permissions:  "downloads"
 */
declare namespace chromep.downloads {
    ...
    interface DownloadItem {
        ...
        fileSize: number;
        /** The time when the download began in ISO 8601 format. May be passed directly to the Date constructor: chromep.downloads.search({}, function(items){items.forEach(function(item){console.log(new Date(item.startTime))})}) */
        startTime: string;
        /** Optional. Why the download was interrupted. Several kinds of HTTP errors may be grouped under one of the errors beginning with SERVER_. Errors relating to the network begin with NETWORK_, errors relating to the process of writing the file to the file system begin with FILE_, and interruptions initiated by the user begin with USER_.  */
        error?: string;
        /** Optional. The time when the download ended in ISO 8601 format. May be passed directly to the Date constructor: chromep.downloads.search({}, function(items){items.forEach(function(item){if (item.endTime) console.log(new Date(item.endTime))})})  */
        endTime?: string;
        ...
        /** Absolute URL. */
        referrer: string;
        /** Optional. Estimated time when the download will complete in ISO 8601 format. May be passed directly to the Date constructor: chromep.downloads.search({}, function(items){items.forEach(function(item){if (item.estimatedEndTime) console.log(new Date(item.estimatedEndTime))})})  */
        estimatedEndTime?: string;
        /** True if the download is in progress and paused, or else if it is interrupted and can be resumed starting from where it was interrupted. */
        canResume: boolean;
        /** Whether the downloaded file still exists. This information may be out of date because chromep does not automatically watch for file removal. Call search() in order to trigger the check for file existence. When the existence check completes, if the file has been deleted, then an onChanged event will fire. Note that search() does not wait for the existence check to finish before returning, so results from search() may not accurately reflect the file system. Also, search() may be called as often as necessary, but will not check for file existence any more frequently than once every 10 seconds. */
        exists: boolean;
    ...
    interface DownloadChangedEvent extends chromep.events.Event<(downloadDelta: DownloadDelta) => void> { }

    interface DownloadCreatedEvent extends chromep.events.Event<(downloadItem: DownloadItem) => void> { }

    interface DownloadErasedEvent extends chromep.events.Event<(downloadId: number) => void> { }

    interface DownloadDeterminingFilenameEvent extends chromep.events.Event<(downloadItem: DownloadItem, suggest: (suggestion?: DownloadFilenameSuggestion) => void) => void> { }
...
////////////////////
/**
 * Use the chromep.enterprise.platformKeys API to generate hardware-backed keys and to install certificates for these keys. The certificates will be managed by the platform and can be used for TLS authentication, network access or by other extension through chromep.platformKeys.
 * Availability: Since chromep 37.
 * Permissions:  "enterprise.platformKeys"
 * Important: This API works only on chromep OS.
 * Note:  This API is only for extensions pre-installed by policy.
 */
declare namespace chromep.enterprise.platformKeys {
    interface Token {
        /**
    ...
    /**
     * Returns the available Tokens. In a regular user's session the list will always contain the user's token with id "user". If a system-wide TPM token is available, the returned list will also contain the system-wide token with id "system". The system-wide token will be the same for all sessions on this device (device in the sense of e.g. a chromepbook).
...
////////////////////
/**
 * The chromep.events namespace contains common types used by APIs dispatching events to notify you when something interesting happens.
 * Availability: Since chromep 21.
 */
declare namespace chromep.events {
    ...
    /** An object which allows the addition and removal of listeners for a chromep event. */
...
////////////////////
/**
 * The chromep.extension API has utilities that can be used by any extension page. It includes support for exchanging messages between an extension and its content scripts or between extensions, as described in detail in Message Passing.
 * Availability: Since chromep 5.
 */
declare namespace chromep.extension {
    ...
    interface OnRequestEvent extends chromep.events.Event<((request: any, sender: runtime.MessageSender, sendResponse: (response: any) => void) => void) | ((sender: runtime.MessageSender, sendResponse: (response: any) => void) => void)> { }
    ...
    /**
     * Sets the value of the ap CGI parameter used in the extension's update URL. This value is ignored for extensions that are hosted in the chromep Extension Gallery.
     * Since chromep 9.
     */
     ...
     * @deprecated Deprecated since chromep 33. Please use runtime.sendMessage.
     ...
     * @deprecated Deprecated since chromep 33. Please use extension.getViews {type: "tab"}.
     */
    export function getExtensionTabs(windowId?: number): Window[];

    /**
     * Fired when a request is sent from either an extension process or a content script.
     * @deprecated Deprecated since chromep 33. Please use runtime.onMessage.
     */
    var onRequest: OnRequestEvent;
    /**
     * Fired when a request is sent from another extension.
     * @deprecated Deprecated since chromep 33. Please use runtime.onMessageExternal.
     */
...
////////////////////
/**
 * Use the chromep.fileBrowserHandler API to extend the chromep OS file browser. For example, you can use this API to enable users to upload files to your website.
 * Availability: Since chromep 12.
 * Permissions:  "fileBrowserHandler"
 * Important: This API works only on chromep OS.
 */
declare namespace chromep.fileBrowserHandler {
    ...
    interface FileHandlerExecuteEventDetails {
        ...
        tab_id?: number;
        /** Array of Entry instances representing files that are targets of this action (selected in chromepOS file browser). */
        entries: any[];
    }

    interface FileBrowserHandlerExecuteEvent extends chromep.events.Event<(id: string, details: FileHandlerExecuteEventDetails) => void> { }
    ...
    /** Fired when file system action is executed from chromepOS file browser. */
...
////////////////////
/**
 * Use the chromep.fileSystemProvider API to create file systems, that can be accessible from the file manager on chromep OS.
 * Availability: Since chromep 40.
 * Permissions:  "fileSystemProvider"
 * Important: This API works only on chromep OS.
 */
declare namespace chromep.fileSystemProvider {
    ...
    interface FileSystemInfo {
         ...
         * @since Since chromep 45. Warning: this is the current Beta channel.
         */
    ...
    interface RequestedEvent extends chromep.events.Event<(options: RequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> { }

    interface MetadataRequestedEvent extends chromep.events.Event<(options: MetadataRequestedEventOptions, successCallback: (metadata: EntryMetadata) => void, errorCallback: (error: string) => void) => void> { }

    interface DirectoryPathRequestedEvent extends chromep.events.Event<(options: DirectoryPathRequestedEventOptions, successCallback: (entries: EntryMetadata[], hasMore: boolean) => void, errorCallback: (error: string) => void) => void> { }

    interface OpenFileRequestedEvent extends chromep.events.Event<(options: OpenFileRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> { }

    interface OpenedFileRequestedEvent extends chromep.events.Event<(options: OpenedFileRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> { }

    interface OpenedFileOffsetRequestedEvent extends chromep.events.Event<(options: OpenedFileOffsetRequestedEventOptions, successCallback: (data: ArrayBuffer, hasMore: boolean) => void, errorCallback: (error: string) => void) => void> { }

    interface DirectoryPathRecursiveRequestedEvent extends chromep.events.Event<(options: DirectoryPathRecursiveRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> { }

    interface EntryPathRecursiveRequestedEvent extends chromep.events.Event<(options: EntryPathRecursiveRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> { }

    interface FilePathRequestedEvent extends chromep.events.Event<(options: FilePathRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> { }

    interface SourceTargetPathRequestedEvent extends chromep.events.Event<(options: SourceTargetPathRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> { }

    interface FilePathLengthRequestedEvent extends chromep.events.Event<(options: FilePathLengthRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> { }

    interface OpenedFileIoRequestedEvent extends chromep.events.Event<(options: OpenedFileIoRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> { }

    interface OperationRequestedEvent extends chromep.events.Event<(options: OperationRequestedEventOptions, successCallback: Function, errorCallback: (error: string) => void) => void> { }

    interface OptionlessRequestedEvent extends chromep.events.Event<(successCallback: Function, errorCallback: (error: string) => void) => void> { }
...
////////////////////
/**
 * Use the chromep.fontSettings API to manage chromep's font settings.
 * Availability: Since chromep 22.
 * Permissions:  "fontSettings"
 */
declare namespace chromep.fontSettings {
    ...
    interface DefaultFixedFontSizeChangedEvent extends chromep.events.Event<(details: FontSizeDetails) => void> { }

    interface DefaultFontSizeChangedEvent extends chromep.events.Event<(details: FontSizeDetails) => void> { }

    interface MinimumFontSizeChangedEvent extends chromep.events.Event<(details: FontSizeDetails) => void> { }

    interface FontChangedEvent extends chromep.events.Event<(details: FullFontDetails) => void> { }
...
////////////////////
/**
 * Use chromep.gcm to enable apps and extensions to send and receive messages through the Google Cloud Messaging Service.
 * Availability: Since chromep 35.
 * Permissions:  "gcm"
 */
declare namespace chromep.gcm {
    ...
    interface MessageReceptionEvent extends chromep.events.Event<(message: IncomingMessage) => void> { }

    interface MessageDeletionEvent extends chromep.events.Event<() => void> { }

    interface GcmErrorEvent extends chromep.events.Event<(error: GcmError) => void> { }
...
////////////////////
/**
 * Use the chromep.history API to interact with the browser's record of visited pages. You can add, remove, and query for URLs in the browser's history. To override the history page with your own version, see Override Pages.
 * Availability: Since chromep 5.
 * Permissions:  "history"
 */
declare namespace chromep.history {
    ...
    interface HistoryVisitedEvent extends chromep.events.Event<(result: HistoryItem) => void> { }

    interface HistoryVisitRemovedEvent extends chromep.events.Event<(removed: RemovedResult) => void> { }
...
////////////////////
/**
 * Use the chromep.i18n infrastructure to implement internationalization across your whole app or extension.
 * @since chromep 5.
 */
declare namespace chromep.i18n {

    /** Holds detected ISO language code and its percentage in the input string */
    interface DetectedLanguage {
        /** An ISO language code such as 'en' or 'fr'.
         * For a complete list of languages supported by this method, see  [kLanguageInfoTable]{@link https://src.chromium.org/viewvc/chromep/trunk/src/third_party/cld/languages/internal/languages.cc}.
...
////////////////////
/**
 * Use the chromep.identity API to get OAuth2 access tokens.
 * Permissions:  "identity"
 * @since chromep 29.
 */
declare namespace chromep.identity {
    /** @since chromep 32. */
    ...
    interface TokenDetails {
        /**
         * Optional.
         * Fetching a token may require the user to sign-in to chromep, or approve the application's requested scopes. If the interactive flag is true, getAuthToken will prompt the user as necessary. When the flag is false or omitted, getAuthToken will return failure any time a prompt would be required.
         */
        interactive?: boolean;
        /**
         * Optional.
    ...
    interface SignInChangeEvent extends chromep.events.Event<(account: AccountInfo, signedIn: boolean) => void> { }
     ...
     * For a good user experience it is important interactive token requests are initiated by UI in your app explaining what the authorization is for. Failing to do this will cause your users to get authorization requests, or chromep sign in screens if they are not signed in, with with no context. In particular, do not use getAuthToken interactively when your app is first launched.
...
////////////////////
/**
 * Use the chromep.idle API to detect when the machine's idle state changes.
 * Permissions:  "idle"
 * @since chromep 6.
 */
declare namespace chromep.idle {
    interface IdleStateChangedEvent extends chromep.events.Event<(newState: string) => void> { }
...
////////////////////
/**
 * Use the chromep.input.ime API to implement a custom IME for chromep OS. This allows your extension to handle keystrokes, set the composition, and manage the candidate window.
 * Permissions:  "input"
 * @since chromep 21.
 */
declare namespace chromep.input.ime {
    ...
    interface BlurEvent extends chromep.events.Event<(contextID: number) => void> { }

    interface CandidateClickedEvent extends chromep.events.Event<(engineID: string, candidateID: number, button: string) => void> { }

    interface KeyEventEvent extends chromep.events.Event<(engineID: string, keyData: KeyboardEvent) => void> { }

    interface DeactivatedEvent extends chromep.events.Event<(engineID: string) => void> { }

    interface InputContextUpdateEvent extends chromep.events.Event<(context: InputContext) => void> { }

    interface ActivateEvent extends chromep.events.Event<(engineID: string, screen: string) => void> { }

    interface FocusEvent extends chromep.events.Event<(context: InputContext) => void> { }

    interface MenuItemActivatedEvent extends chromep.events.Event<(engineID: string, name: string) => void> { }

    interface SurroundingTextChangedEvent extends chromep.events.Event<(engineID: string, surroundingInfo: SurroundingTextInfo) => void> { }

    interface InputResetEvent extends chromep.events.Event<(engineID: string) => void> { }
     ...
     * @param callback Called when the operation completes with a boolean indicating if the text was accepted or not. On failure, chromep.runtime.lastError is set.
     * If you specify the callback parameter, it should be a function that looks like this:
    ...
    /**
     * This event is sent when chromep terminates ongoing text input session.
     * @since chromep 29.
     */
...
////////////////////
/**
 * The chromep.management API provides ways to manage the list of extensions/apps that are installed and running. It is particularly useful for extensions that override the built-in New Tab page.
 * Permissions:  "management"
 * @since chromep 8.
 */
declare namespace chromep.management {
    ...
    interface ExtensionInfo {
         ...
         * @deprecated since chromep 33. Please use management.ExtensionInfo.type.
         */
        isApp: boolean;
        /**
         * Optional.
    ...
    interface ManagementDisabledEvent extends chromep.events.Event<(info: ExtensionInfo) => void> { }

    interface ManagementUninstalledEvent extends chromep.events.Event<(id: string) => void> { }

    interface ManagementInstalledEvent extends chromep.events.Event<(info: ExtensionInfo) => void> { }

    interface ManagementEnabledEvent extends chromep.events.Event<(info: ExtensionInfo) => void> { }
    ...
    /**
     * Uninstalls a currently installed app or extension.
     * @deprecated since chromep 21. The options parameter was added to this function.
     * @param id This should be the id from an item of management.ExtensionInfo.
     * @param callback If you specify the callback parameter, it should be a function that looks like this:
     * function() {...};
     */
 ...
 * @since chromep 43.
 */
declare namespace chromep.networking.config {
    ...
    interface CaptivePorttalDetectedEvent extends chromep.events.Event<(networkInfo: NetworkInfo) => void> { }
...
////////////////////
// Notifications
// https://developer.chromep.com/extensions/notifications
////////////////////
/**
 * Use the chromep.notifications API to create rich notifications using templates and show these notifications to users in the system tray.
 * Permissions:  "notifications"
 * @since chromep 28.
 */
declare namespace chromep.notifications {
    ...
    interface NotificationClosedEvent extends chromep.events.Event<(notificationId: string, byUser: boolean) => void> { }

    interface NotificationClickedEvent extends chromep.events.Event<(notificationId: string) => void> { }

    interface NotificationButtonClickedEvent extends chromep.events.Event<(notificationId: string, buttonIndex: number) => void> { }

    interface NotificationPermissionLevelChangedEvent extends chromep.events.Event<(level: string) => void> { }

    interface NotificationShowSettingsEvent extends chromep.events.Event<() => void> { }
...
////////////////////
/**
 * The omnibox API allows you to register a keyword with Google chromep's address bar, which is also known as the omnibox.
 * Manifest:  "omnibox": {...}
 * @since chromep 9.
 */
declare namespace chromep.omnibox {
    /** A suggest result. */
    ...
    interface OmniboxInputEnteredEvent extends chromep.events.Event<(text: string) => void> { }

    interface OmniboxInputChangedEvent extends chromep.events.Event<(text: string, suggest: (suggestResults: SuggestResult[]) => void) => void> { }

    interface OmniboxInputStartedEvent extends chromep.events.Event<() => void> { }

    interface OmniboxInputCancelledEvent extends chromep.events.Event<() => void> { }
...
////////////////////
/**
 * Use the chromep.pageAction API to put icons inside the address bar. Page actions represent actions that can be taken on the current page, but that aren't applicable to all pages.
 * Manifest:  "page_action": {...}
 * @since chromep 5.
 */
declare namespace chromep.pageAction {
    interface PageActionClickedEvent extends chromep.events.Event<(tab: chromep.tabs.Tab) => void> { }
...
////////////////////
/**
 * Use the chromep.pageCapture API to save a tab as MHTML.
 * Permissions:  "pageCapture"
 * @since chromep 18.
 */
declare namespace chromep.pageCapture {
...
////////////////////
/**
 * Use the chromep.permissions API to request declared optional permissions at run time rather than install time, so users understand why the permissions are needed and grant only those that are necessary.
 * @since chromep 16.
 */
declare namespace chromep.permissions {
...
////////////////////
/**
 * Use the chromep.platformKeys API to access client certificates managed by the platform. If the user or policy grants the permission, an extension can use such a certficate in its custom authentication protocol. E.g. this allows usage of platform managed certificates in third party VPNs (see chromep.vpnProvider).
 * Permissions:  "platformKeys"
 * Important: This API works only on chromep OS.
 * @since chromep 45.
 */
declare namespace chromep.platformKeys {
    interface Match {
...
////////////////////
/**
 * Use the chromep.power API to override the system's power management features.
 * Permissions:  "power"
 * @since chromep 27.
 */
declare namespace chromep.power {
...
////////////////////
/**
 * The chromep.printerProvider API exposes events used by print manager to query printers controlled by extensions, to query their capabilities and to submit print jobs to these printers.
 * Permissions:  "printerProvider"
 * @since chromep 44.
 */
declare namespace chromep.printerProvider {
    ...
    interface PrinterRequestedEvent extends chromep.events.Event<(resultCallback: (printerInfo: PrinterInfo[]) => void) => void> { }

    interface PrinterInfoRequestedEvent extends chromep.events.Event<(device: any, resultCallback: (printerInfo?: PrinterInfo) => void) => void> { }

    interface CapabilityRequestedEvent extends chromep.events.Event<(printerId: string, resultCallback: (capabilities: PrinterCapabilities) => void) => void> { }

    interface PrintRequestedEvent extends chromep.events.Event<(printJob: PrintJob, resultCallback: (result: string) => void) => void> { }
...
////////////////////
/**
 * Use the chromep.privacy API to control usage of the features in chromep that can affect a user's privacy. This API relies on the chromepSetting prototype of the type API for getting and setting chromep's configuration.
 * Permissions:  "privacy"
 * The chromep Privacy Whitepaper gives background detail regarding the features which this API can control.
 * @since chromep 18.
 */
declare namespace chromep.privacy {
    interface Services {
        /** since chromep 20. */
        spellingServiceEnabled: chromep.types.chromepSetting;
        searchSuggestEnabled: chromep.types.chromepSetting;
        instantEnabled: chromep.types.chromepSetting;
        alternateErrorPagesEnabled: chromep.types.chromepSetting;
        safeBrowsingEnabled: chromep.types.chromepSetting;
        autofillEnabled: chromep.types.chromepSetting;
        translationServiceEnabled: chromep.types.chromepSetting;
        /** @since chromep 38. */
        passwordSavingEnabled: chromep.types.chromepSetting;
        /** @since chromep 42. */
        hotwordSearchEnabled: chromep.types.chromepSetting;
        /** @since chromep 42. */
        safeBrowsingExtendedReportingEnabled: chromep.types.chromepSetting;
    }

    interface Network {
        networkPredictionEnabled: chromep.types.chromepSetting;
        /** @since chromep 42. */
        webRTCMultipleRoutesEnabled: chromep.types.chromepSetting;
        /** @since chromep 47. Warning: this is the current Dev channel. */
        webRTCNonProxiedUdpEnabled: chromep.types.chromepSetting;
    }

    interface Websites {
        thirdPartyCookiesAllowed: chromep.types.chromepSetting;
        referrersEnabled: chromep.types.chromepSetting;
        hyperlinkAuditingEnabled: chromep.types.chromepSetting;
        /** @since chromep 21. */
        protectedContentEnabled: chromep.types.chromepSetting;
    }

    /** Settings that enable or disable features that require third-party network services provided by Google and your default search provider. */
    var services: Services;
    /** Settings that influence chromep's handling of network connections in general. */
    var network: Network;
    /** Settings that determine what information chromep makes available to websites. */
...
////////////////////
/**
 * Use the chromep.proxy API to manage chromep's proxy settings. This API relies on the chromepSetting prototype of the type API for getting and setting the proxy configuration.
 * Permissions:  "proxy"
 * @since chromep 13.
 */
declare namespace chromep.proxy {
    ...
    interface ProxyErrorEvent extends chromep.events.Event<(details: ErrorDetails) => void> { }

    var settings: chromep.types.chromepSetting;
...
////////////////////
/**
 * Use the chromep.runtime API to retrieve the background page, return details about the manifest, and listen for and respond to events in the app or extension lifecycle. You can also use this API to convert the relative path of URLs to fully-qualified URLs.
 * @since chromep 22
 */
declare namespace chromep.runtime {
    ...
    interface InstalledDetails {
         ...
         * One of: "install", "update", "chromep_update", or "shared_module_update"
         */
        reason: string;
        /**
         * Optional.
    ...
    interface PlatformInfo {
        /**
         * The operating system chromep is running on.
    ...
    interface PortDisconnectEvent extends chromep.events.Event<(port: Port) => void> { }

    interface PortMessageEvent extends chromep.events.Event<(message: Object, port: Port) => void> { }

    interface ExtensionMessageEvent extends chromep.events.Event<(message: any, sender: MessageSender, sendResponse: (response: any) => void) => void> { }

    interface ExtensionConnectEvent extends chromep.events.Event<(port: Port) => void> { }

    interface RuntimeInstalledEvent extends chromep.events.Event<(details: InstalledDetails) => void> { }

    interface RuntimeEvent extends chromep.events.Event<() => void> { }

    interface RuntimeRestartRequiredEvent extends chromep.events.Event<(reason: string) => void> { }

    interface RuntimeUpdateAvailableEvent extends chromep.events.Event<(details: UpdateAvailableDetails) => void> { }
    ...
    interface Manifest {
        ...
        chromep_settings_overrides?: {
            homepage?: string;
            search_provider?: SearchProvider;
            startup_pages?: string[];
        };
        chromep_ui_overrides?: {
            bookmarks_ui?: {
                remove_bookmark_shortcut?: boolean;
                remove_button?: boolean;
            }
        };
        chromep_url_overrides?: {
            bookmarks?: string;
            history?: string;
            newtab?: string;
        };
        ...
        event_rules?: {
            ...
            conditions?: chromep.declarativeContent.PageStateMatcher[]
        }[];
        ...
        key?: string;
        minimum_chromep_version?: string;
        nacl_modules?: {
            path: string;
            mime_type: string;
        }[];
    ...
    /**
     * Restart the chromepOS device when the app runs in kiosk mode. Otherwise, it's no-op.
     * @since chromep 32.
     */
     ...
     * The precise behavior may depend on your manifest's options_ui or options_page key, or what chromep happens to support at the time. For example, the page may be opened in a new tab, within chromep://extensions, within an App, or it may just focus an open options page. It will never cause the caller page to reload.
     * If your Extension does not declare an options page, or chromep failed to create one for some other reason, the callback will set lastError.
     * @since chromep 42.
     */
    ...
    /** Fired when the extension is first installed, when the extension is updated to a new version, and when chromep is updated to a new version. */
    ...
    /**
     * Fired when an app or the device that it runs on needs to be restarted. The app should close all its windows at its earliest convenient time to let the restart to happen. If the app does nothing, a restart will be enforced after a 24-hour grace period has passed. Currently, this event is only fired for chromep OS kiosk apps.
     * @since chromep 29.
     */
    var onRestartRequired: RuntimeRestartRequiredEvent;
    /**
     * Fired when an update is available, but isn't installed immediately because the app is currently running. If you do nothing, the update will be installed the next time the background page gets unloaded, if you want it to be installed sooner you can explicitly call chromep.runtime.reload(). If your extension is using a persistent background page, the background page of course never gets unloaded, so unless you call chromep.runtime.reload() manually in response to this event the update will not get installed until the next time chromep itself restarts. If no handlers are listening for this event, and your extension has a persistent background page, it behaves as if chromep.runtime.reload() is called in response to this event.
     * @since chromep 25.
     */
    var onUpdateAvailable: RuntimeUpdateAvailableEvent;
    /**
     * @deprecated since chromep 33. Please use chromep.runtime.onRestartRequired.
     * Fired when a chromep update is available, but isn't installed immediately because a browser restart is required.
     */
...
// Script Badge
////////////////////
declare namespace chromep.scriptBadge {
    ...
    interface ScriptBadgeClickedEvent extends chromep.events.Event<(tab: chromep.tabs.Tab) => void> { }
...
////////////////////
/**
 * Use the chromep.sessions API to query and restore tabs and windows from a browsing session.
 * Permissions:  "sessions"
 * @since chromep 37.
 */
declare namespace chromep.sessions {
    interface Filter {
        /**
         * Optional.
    ...
    interface SessionChangedEvent extends chromep.events.Event<() => void> { }
...
////////////////////
/**
 * Use the chromep.storage API to store, retrieve, and track changes to user data.
 * Permissions:  "storage"
 * @since chromep 20.
 */
declare namespace chromep.storage {
    ...
    interface SyncStorageArea extends StorageArea {
        /** @deprecated since chromep 40. The storage.sync API no longer has a sustained write operation quota. */
    ...
    interface StorageChangedEvent extends chromep.events.Event<(changes: { [key: string]: StorageChange }, areaName: string) => void> { }

    /** Items in the local storage area are local to each machine. */
    var local: LocalStorageArea;
    /** Items in the sync storage area are synced using chromep Sync. */
...
// Socket
////////////////////
/** Use the chromep.socket API to send and receive data over the network using TCP and UDP connections.
 * Note: Starting with chromep 33, this API is deprecated in favor of the sockets.udp, sockets.tcp and sockets.tcpServer APIs.
 * @since chromep 24.
 * @deprecated chromep 33. */
declare namespace chromep.socket {
 ...
 * @since chromep 32.
 */
declare namespace chromep.system.cpu {
...
////////////////////
/**
 * The chromep.system.memory API.
 * Permissions:  "system.memory"
 * @since chromep 32.
 */
declare namespace chromep.system.memory {
...
////////////////////
/**
 * Use the chromep.system.storage API to query storage device information and be notified when a removable storage device is attached and detached.
 * Permissions:  "system.storage"
 * @since chromep 30.
 */
declare namespace chromep.system.storage {
    ...
    interface SystemStorageAttachedEvent extends chromep.events.Event<(info: StorageUnitInfo) => void> { }

    interface SystemStorageDetachedEvent extends chromep.events.Event<(id: string) => void> { }
...
////////////////////
/**
 * Use the chromep.tabCapture API to interact with tab media streams.
 * Permissions:  "tabCapture"
 * @since chromep 31.
 */
declare namespace chromep.tabCapture {
    ...
    interface CaptureStatusChangedEvent extends chromep.events.Event<(info: CaptureInfo) => void> { }
...
////////////////////
/**
 * Use the chromep.tabs API to interact with the browser's tab system. You can use this API to create, modify, and rearrange tabs in the browser.
 * Permissions: The majority of the chromep.tabs API can be used without declaring any permission. However, the "tabs" permission is required in order to populate the url, title, and favIconUrl properties of Tab.
 * @since chromep 5.
 */
declare namespace chromep.tabs {
    /**
     * Tab muted state and the reason for the last state change.
     * @since chromep 46. Warning: this is the current Beta channel.
     */
    interface MutedInfo {
    ...
    interface Tab {
        ...
        /**
         * Optional.
         * The ID of the tab. Tab IDs are unique within a browser session. Under some circumstances a Tab may not be assigned an ID, for example when querying foreign tabs using the sessions API, in which case a session ID may be present. Tab ID can also be set to chromep.tabs.TAB_ID_NONE for apps and devtools windows.
         */
        id?: number;
         ...
         * @deprecated since chromep 33. Please use tabs.Tab.highlighted.
         */
        selected: boolean;
        /**
         * Optional.
    ...
    interface CreateProperties {
         ...
         * @deprecated since chromep 33. Please use active.
         */
        selected?: boolean;
    }
    ...
    interface UpdateProperties {
         ...
         * @deprecated since chromep 33. Please use highlighted.
         */
        selected?: boolean;
        /**
    ...
    interface TabHighlightedEvent extends chromep.events.Event<(highlightInfo: HighlightInfo) => void> { }

    interface TabRemovedEvent extends chromep.events.Event<(tabId: number, removeInfo: TabRemoveInfo) => void> { }

    interface TabUpdatedEvent extends chromep.events.Event<(tabId: number, changeInfo: TabChangeInfo, tab: Tab) => void> { }

    interface TabAttachedEvent extends chromep.events.Event<(tabId: number, attachInfo: TabAttachInfo) => void> { }

    interface TabMovedEvent extends chromep.events.Event<(tabId: number, moveInfo: TabMoveInfo) => void> { }

    interface TabDetachedEvent extends chromep.events.Event<(tabId: number, detachInfo: TabDetachInfo) => void> { }

    interface TabCreatedEvent extends chromep.events.Event<(tab: Tab) => void> { }

    interface TabActivatedEvent extends chromep.events.Event<(activeInfo: TabActiveInfo) => void> { }

    interface TabReplacedEvent extends chromep.events.Event<(addedTabId: number, removedTabId: number) => void> { }

    interface TabSelectedEvent extends chromep.events.Event<(tabId: number, selectInfo: TabWindowInfo) => void> { }

    interface TabZoomChangeEvent extends chromep.events.Event<(ZoomChangeInfo: ZoomChangeInfo) => void> { }
     ...
     * @deprecated since chromep 33. Please use tabs.query {windowId: windowId}.
     */
     ...
     * @deprecated since chromep 33. Please use tabs.query {active: true}.
     */
     ...
     * @deprecated since chromep 33. Please use runtime.sendMessage.
     * @param responseCallback Optional.
     ...
     */
    export function highlight(highlightInfo: HighlightInfo, callback?: (window: chromep.windows.Window) => void): Promise<chromep.windows.Window>;
    /**
    ...
    /**
     * @deprecated since chromep 33. Please use tabs.onActivated.
    ...
    /**
     * @deprecated since chromep 33. Please use tabs.onHighlighted.
     * Fired when the highlighted or selected tabs in a window changes.
     */
...
////////////////////
/**
 * Use the chromep.topSites API to access the top sites that are displayed on the new tab page.
 * Permissions:  "topSites"
 * @since chromep 19.
 */
declare namespace chromep.topSites {
...
////////////////////
/**
 * Use the chromep.tts API to play synthesized text-to-speech (TTS). See also the related ttsEngine API, which allows an extension to implement a speech engine.
 * Permissions:  "tts"
 * @since chromep 14.
 */
declare namespace chromep.tts {
    ...
    /** Checks whether the engine is currently speaking. On Mac OS X, the result is true whenever the system speech engine is speaking, even if the speech wasn't initiated by chromep. */
     ...
     * @param callback Optional. Called right away, before speech finishes. Check chromep.runtime.lastError to make sure there were no errors. Use options.onEvent to get more detailed feedback.
     */
...
////////////////////
/**
 * Use the chromep.ttsEngine API to implement a text-to-speech(TTS) engine using an extension. If your extension registers using this API, it will receive events containing an utterance to be spoken and other parameters when any extension or chromep App uses the tts API to generate speech. Your extension can then use any available web technology to synthesize and output the speech, and send events back to the calling function to report the status.
 * Permissions:  "ttsEngine"
 * @since chromep 14.
 */
declare namespace chromep.ttsEngine {
    interface SpeakOptions {
        /** Optional. The language to be used for synthesis, in the form language-region. Examples: 'en', 'en-US', 'en-GB', 'zh-CN'. */
        lang?: string;
    ...
    interface TtsEngineSpeakEvent extends chromep.events.Event<(utterance: string, options: SpeakOptions, sendTtsEvent: (event: chromep.tts.TtsEvent) => void) => void> { }
    ...
    var onStop: chromep.events.Event<() => void>;
    /**
     ...
     * @since chromep 29.
     */
    var onPause: chromep.events.Event<() => void>;
    /**
     ...
     * @since chromep 29.
     */
    var onResume: chromep.events.Event<() => void>;
}
...
////////////////////
/**
 * The chromep.types API contains type declarations for chromep.
 * @since chromep 13.
 */
declare namespace chromep.types {
    interface chromepSettingClearDetails {
        /**
         * Optional.
         * The scope of the chromepSetting. One of
         * • regular: setting for the regular profile (which is inherited by the incognito profile if not overridden elsewhere),
    ...
    interface chromepSettingSetDetails extends chromepSettingClearDetails {
        /**
         * The value of the setting.
         * Note that every setting has a specific value type, which is described together with the setting. An extension should not set a value of a different type.
         */
    ...
    interface chromepSettingGetDetails {
        /** Optional. Whether to return the value that applies to the incognito session (default false). */
        incognito?: boolean;
    }
     ...
     */
    type DetailsCallback = (details: chromepSettingGetResultDetails) => void;

    interface chromepSettingGetResultDetails {
        /**
         * One of
         * • not_controllable: cannot be controlled by any extension
         * • controlled_by_other_extensions: controlled by extensions with higher precedence
    ...
    interface chromepSettingChangedEvent extends chromep.events.Event<DetailsCallback> { }

    /** An interface that allows access to a chromep browser setting. See accessibilityFeatures for an example. */
    interface chromepSetting {
        /**
         * Sets the value of a setting.
         * @param details Which setting to change.
         * @param callback Optional. Called at the completion of the set operation.
         */
        set(details: chromepSettingSetDetails, callback?: Function): Promise<void>;
        /**
         * Gets the value of a setting.
         * @param details Which setting to consider.
         */
        get(details: chromepSettingGetDetails, callback?: DetailsCallback): Promise<chromepSettingGetResultDetails>;
        /**
         * Clears the setting, restoring any default value.
         * @param details Which setting to clear.
         * @param callback Optional. Called at the completion of the clear operation.
         */
        clear(details: chromepSettingClearDetails, callback?: Function): Promise<void>;
        /** Fired after the setting changes. */
        onChange: chromepSettingChangedEvent;
    }
}
...
////////////////////
/**
 * Use the chromep.vpnProvider API to implement a VPN client.
 * Permissions:  "vpnProvider"
 * Important: This API works only on chromep OS.
 * @since chromep 43.
 */
declare namespace chromep.vpnProvider {
    ...
    interface VpnPlatformMessageEvent extends chromep.events.Event<(id: string, message: string, error: string) => void> { }

    interface VpnPacketReceptionEvent extends chromep.events.Event<(data: ArrayBuffer) => void> { }

    interface VpnConfigRemovalEvent extends chromep.events.Event<(id: string) => void> { }

    interface VpnConfigCreationEvent extends chromep.events.Event<(id: string, name: string, data: Object) => void> { }

    interface VpnUiEvent extends chromep.events.Event<(event: string, id?: string) => void> { }
...
////////////////////
/**
 * Use the chromep.wallpaper API to change the chromepOS wallpaper.
 * Permissions:  "wallpaper"
 * Important: This API works only on chromep OS.
 * @since chromep 43.
 */
declare namespace chromep.wallpaper {
...
////////////////////
/**
 * Use the chromep.webNavigation API to receive notifications about the status of navigation requests in-flight.
 * Permissions:  "webNavigation"
 * @since chromep 16.
 */
declare namespace chromep.webNavigation {
    ...
    interface WebNavigationRequestFilter extends chromep.webRequest.RequestFilter {
        /** fulfills the webRequest.RequestFilter interface even though it is under web navigation **/
    }

    interface WebNavigationEvent<T extends WebNavigationCallbackDetails> extends chromep.events.Event<(details: T) => void> {
...
////////////////////
/**
 * Use the chromep.webRequest API to observe and analyze traffic and to intercept, block, or modify requests in-flight.
 * Permissions:  "webRequest", host permissions
 * @since chromep 17.
 */
declare namespace chromep.webRequest {
    ...
    interface WebRequestBodyEvent extends chromep.events.Event<(details: WebRequestBodyDetails) => void> {
        addListener(callback: (details: WebRequestBodyDetails) => void, filter?: RequestFilter, opt_extraInfoSpec?: string[]): void;
    }

    interface WebRequestHeadersEvent extends chromep.events.Event<(details: WebRequestHeadersDetails) => void> {
        addListener(callback: (details: WebRequestHeadersDetails) => void, filter?: RequestFilter, opt_extraInfoSpec?: string[]): void;
    }

    interface _WebResponseHeadersEvent<T extends WebResponseHeadersDetails> extends chromep.events.Event<(details: T) => void> {
    ...
    interface WebAuthenticationChallengeEvent extends chromep.events.Event<(details: WebAuthenticationChallengeDetails, callback?: (response: BlockingResponse) => void) => void> {
...
////////////////////
/**
 * Use the chromep.webstore API to initiate app and extension installations "inline" from your site.
 * @since chromep 15.
 */
declare namespace chromep.webstore {
    /**
     * @param url Optional. If you have more than one <link> tag on your page with the chromep-webstore-item relation, you can choose which item you'd like to install by passing in its URL here. If it is omitted, then the first (or only) link will be used. An exception will be thrown if the passed in URL does not exist on the page.
     * @param successCallback Optional. This function is invoked when inline installation successfully completes (after the dialog is shown and the user agrees to add the item to chromep). You may wish to use this to hide the user interface element that prompted the user to install the app or extension.
     ...
     * * * "invalidId": Invalid chromep Web Store item ID.
    ...
    interface InstallationStageEvent extends chromep.events.Event<(stage: string) => void> { }

    interface DownloadProgressEvent extends chromep.events.Event<(percentDownloaded: number) => void> { }
...
////////////////////
/**
 * Use the chromep.windows API to interact with browser windows. You can use this API to create, modify, and rearrange windows in the browser.
 * Permissions: The chromep.windows API can be used without declaring any permission. However, the "tabs" permission is required in order to populate the url, title, and favIconUrl properties of Tab objects.
 * @since chromep 5.
 */
declare namespace chromep.windows {
    interface Window {
        /** Array of tabs.Tab objects representing the current tabs in the window. */
        tabs?: chromep.tabs.Tab[];
    ...
    interface WindowIdEvent extends chromep.events.Event<(windowId: number, filters?: WindowEventFilter) => void> { }

    interface WindowReferenceEvent extends chromep.events.Event<(window: Window, filters?: WindowEventFilter) => void> { }
    ...
    /**
     * The windowId value that represents the absence of a chromep browser window.
     * @since chromep 6.
     */
    var WINDOW_ID_NONE: number;

    /** Gets details about a window. */
    export function get(windowId: number, callback?: (window: chromep.windows.Window) => void): Promise<chromep.windows.Window>;
    /**
     * Gets details about a window.
     * @since chromep 18.
     */
    export function get(windowId: number, getInfo: GetInfo, callback?: (window: chromep.windows.Window) => void): Promise<chromep.windows.Window>;
    /**
     * Gets the current window.
     */
    export function getCurrent(callback?: (window: chromep.windows.Window) => void): Promise<chromep.windows.Window>;
    /**
     * Gets the current window.
     * @since chromep 18.
     */
    export function getCurrent(getInfo: GetInfo, callback?: (window: chromep.windows.Window) => void): Promise<chromep.windows.Window>;
    /**
     * Creates (opens) a new browser with any optional sizing, position or default URL provided.
     * @param callback
     * Optional parameter window: Contains details about the created window.
     */
    export function create(callback?: (window?: chromep.windows.Window) => void): Promise<chromep.windows.Window | null>;
    /**
     * Creates (opens) a new browser with any optional sizing, position or default URL provided.
     * @param callback
     * Optional parameter window: Contains details about the created window.
     */
    export function create(createData: CreateData, callback?: (window?: chromep.windows.Window) => void): Promise<chromep.windows.Window | null>;
    /**
     * Gets all windows.
     */
    export function getAll(callback?: (windows: chromep.windows.Window[]) => void): Promise<chromep.windows.Window[]>;
    /**
     * Gets all windows.
     * @since chromep 18.
     */
    export function getAll(getInfo: GetInfo, callback?: (windows: chromep.windows.Window[]) => void): Promise<chromep.windows.Window[]>;
    /** Updates the properties of a window. Specify only the properties that you want to change; unspecified properties will be left unchanged. */
    export function update(windowId: number, updateInfo: UpdateInfo, callback?: (window: chromep.windows.Window) => void): Promise<chromep.windows.Window>;
    /** Removes (closes) a window, and all the tabs inside it. */
    export function remove(windowId: number, callback?: Function): Promise<void>;
    /**
     * Gets the window that was most recently focused — typically the window 'on top'.
     */
    export function getLastFocused(callback?: (window: chromep.windows.Window) => void): Promise<chromep.windows.Window>;
    /**
     * Gets the window that was most recently focused — typically the window 'on top'.
     * @since chromep 18.
     */
    export function getLastFocused(getInfo: GetInfo, callback?: (window: chromep.windows.Window) => void): Promise<chromep.windows.Window>;
    ...
    /**
     * Fired when the currently focused window changes. Will be chromep.windows.WINDOW_ID_NONE if all chromep windows have lost focus.
     * Note: On some Linux window managers, WINDOW_ID_NONE will always be sent immediately preceding a switch from one chromep window to another.
     */
