...
export function isEmpty (obj) {
    ...
    // 检验空字符串和纯空白字符串
    if (Object.prototype.toString.call(obj) === '[object String]' && (obj === '' || obj.replace(/^\s+|\s+$/g, '') === '')) {
        return true
    }
    // 检验数组
 ...
 * errors:错误提示
 */
export function isCardId (n, value) {
    switch (n) {
        case '10':
            if (value.length === 15) {
        ...
        case '11':
            var rel11 = /^[0-9a-zA-Z]{4,15}$/;
            return rel11.test(value)
        case '12':
            var rel12 = /^[0-9a-zA-Z]{4,15}$/;
            return rel12.test(value)
        case '13':
            var rel13 = /^[0-9a-zA-Z]{8,9}$/;
            return rel13.test(value)
        case '14':
            var rel14 = /^[HMhm]{1}([0-9]{10}|[0-9]{8})$/;
            return rel14.test(value)
        case '15':
            var rel15 = /(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/;
            return rel15.test(value)
        case '16':
            var rel16 = /^((\s?[A-Za-z])|([A-Za-z]{2}))\d{6}((\([0−9aA]\))|(\([0-9aA]\)))$/;
            return rel16.test(value)
        case '17':
            var rel17 = /^[1|5|7][0-9]{6}\([0-9Aa]\)$/;
            return rel17.test(value)
        case '18':
            var rel18 = /^[A-KM-QT-XZ]{1}[0-9]{9}$/;
            return rel18.test(value)
        case '19':
            var rel19 = /^[0-9a-zA-Z]{4,20}$/;
            return rel19.test(value)
        case '20':
            var rel20 = /^[0-9a-zA-Z]{4,20}$/;
            return rel20.test(value)
        case '21':
            var rel21 = /(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/;
            return rel21.test(value)
        case '90':
            var rel90 = /^[0-9a-zA-Z]{4,20}$/;
            return rel90.test(value)
    }
}
